...
def main():
  ...
  subparsers.add_parser('make-crafter-csv', help="Generates a CSV file for every profession")

  # MULTIPLE ARG COMMANDS
  comm_parse_page = subparsers.add_parser('make-profession-csv', help="Generates a CSV file for a single profession. e.g. <main.py make-profession-csv blacksmith>")
